...
SECRET_KEY = 'django-insecure-n8iy_bp3c*#m=06c_2&nnuavno)^go$03d5aw51$899r6bhg)='
...
AUTH_USER_MODEL = 'user.User' # The model in the user app I created
...
SIMPLE_JWT = {
    ...
    'ALGORITHM': 'HS256' # the algorithm used to sign the token. The fomula on how the token is made
}
